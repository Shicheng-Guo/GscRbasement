...
write.csv(out3,file=paste("pancancer.chol.rnaseq.","OS.HR.csv",sep=""),quote=F)
write.table(out3,file=paste("pancancer.chol.rnaseq.","OS.HR.txt",sep=""),quote=F,sep="\t",col.names=NA,row.names=T)
