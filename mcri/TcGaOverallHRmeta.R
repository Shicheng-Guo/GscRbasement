...
write.table(out3,file=paste("tcga.pancancer.meta.pvalue.slow.txt",sep=""),sep="\t",quote=F,col.names = NA,row.names = T)
write.csv(out3,file=paste("tcga.pancancer.meta.pvalue.slow.csv",sep=""),quote=F)
