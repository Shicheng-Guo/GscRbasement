...
ls
memo="TSG"
symbolist<-as.character(read.table("https://raw.githubusercontent.com/Shicheng-Guo/tcga/master/extdata/suppressor/FullTumorSuppressorGeneList.txt",as.is=T)[,2])
