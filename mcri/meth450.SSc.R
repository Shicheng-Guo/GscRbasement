...
rnb.options(filtering.sex.chromosomes.removal=TRUE,normalization.method = "bmiq",filtering.greedycut.pvalue.threshold=0.05,filtering.missing.value.quantile=0, filtering.deviation.threshold=0,filtering.snp="any",filtering.cross.reactive = TRUE);
...
diffcomp = function(working_directory="",data_matrix="CD4_RGSS_data_aftercombatM.RData",clinical_file="CD4_RGSS_clinical.csv", case="Case", control="Control"){
