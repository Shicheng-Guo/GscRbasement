...
save(matrix,file="scRNA-thryoid-tcga-Rnaseq.RData")

library("gplots")

library("gplots")
pdf("heatmap3-Rnaseq.pdf")
...
pdf("heatmap2-Rnaseq.pdf")
heatmap(scale(matrix),Rowv=NA,Colv=NA)
dev.off()
...
pdf("heatmap4-Rnaseq.pdf")
HeatMap(scale(matrix),Rowv=T,Colv=F)
dev.off()

pdf("heatmap5-Rnaseq.pdf")
HeatMap(matrix,Rowv=F,Colv=F)
dev.off()

pdf("heatmap6-Rnaseq.pdf")
