...
print OUT "trim_galore --paired --stringency 1 --fastqc -e 0.2 --phred$phred --clip_R1 2 --clip_R2 2 --fastqc --illumina $sample1\.fastq.gz $sample2\.fastq.gz --output_dir ../fastq_trim\n";
